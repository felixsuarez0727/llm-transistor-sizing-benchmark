"""
Zero-shot evaluation — Anthropic Claude models.
Usage:
  python3 evaluation/baseline/evaluate_llm_claude.py \
      --index dataset/small/index.json --split small [--model claude-sonnet-4-6]
"""
