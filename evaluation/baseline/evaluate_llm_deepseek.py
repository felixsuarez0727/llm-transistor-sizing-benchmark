"""
Zero-shot evaluation — DeepSeek models (OpenAI-compatible API).
Usage:
  python3 evaluation/baseline/evaluate_llm_deepseek.py \
      --index dataset/small/index.json --split small [--model deepseek-chat]
"""
