"""
Iterative evaluation — DeepSeek models.
Usage:
  python3 evaluation/improved/evaluate_llm_deepseek_iterative.py \
      --index dataset/small/index.json --split small --rounds 3 [--model deepseek-chat]
"""
