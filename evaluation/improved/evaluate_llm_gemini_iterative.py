"""
Iterative evaluation — Google Gemini models.
Usage:
  python3 evaluation/improved/evaluate_llm_gemini_iterative.py \
      --index dataset/small/index.json --split small --rounds 3 [--model gemini-2.5-flash]
"""
